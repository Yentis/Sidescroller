...
var horizontalOffset : float = 5;
var diagonalOffset : float = 1;
}
...
function MoveCamera() {
transform.position.x = target.position.x + settings.horizontalOffset;
transform.position.y = target.position.y + settings.verticalOffset;
transform.position.z = target.position.z + settings.diagonalOffset;
}